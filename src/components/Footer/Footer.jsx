...
import backgroundImg11 from '../../assets/images/azulclaro.png'; 
      ...
      <div className="mb-10 w-[90%] grid gap-2 md:gap-4 lg:gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 m-[auto] items-start justify-items-center">
        ...
        <div data-aos="fade-up" className='mt-10 w-[100%] md:w-[100%] lg:w-[100%] order-1 md:order-1 lg:order-1 '>
          <div className='flex justify-center items-center'>
            <Link to="/" >
              <img src={backgroundImg11} alt="logo" className='mb-0 w-auto' />
            </Link>
          </div>
         
          <div className='flex justify-center items-center mt-5'>
            <p className='max-w-[15rem] py-3 text-base'>Tech Solucion é uma empresa com serviços voltados para o desenvolvimento empresarial</p>
          </div>
          
          <div className='flex justify-center items-center gap-3 py-2 mt-5 '>
            <a style={{ textDecoration: "none" }} target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/gustavo_malimpensa/" className='mx-3' >
            ...
            <a style={{ textDecoration: "none" }} target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/gustavo-malimpensa/" className='mx-8'>
            ...
            <a style={{ textDecoration: "none" }} target="_blank" rel="noopener noreferrer" href="https://twitter.com/T_E_S_L_Aclub" className='mx-3'>
        ...
        <div data-aos="fade-up" className='mt-10 w-[100%] md:w-[100%] lg:w-[100%] order-2 md:order-2 lg:order-2'>
          <div className='flex items-center justify-center'><h1 className='font-extrabold text-2xl text-blue-700 mr-3'>|</h1><h1 className='text-lg font-semibold'>Deve verificar</h1></div>
          <ul className='mt-4 flex flex-col gap-2 text-base justify-center items-center'>
            ...
            <li className=' hover:text-blue-600'><Link style={{ textDecoration: "none" }} to="/"><p className='text-gray-400 hover:text-sky-500'>Consultoria</p></Link></li>
            <li className=' hover:text-blue-600'><Link style={{ textDecoration: "none" }} to="/"><p className='text-gray-400 hover:text-sky-500'>Desenvolvimento</p></Link></li>
            <li className=' hover:text-blue-600'><Link style={{ textDecoration: "none" }} to="/"><p className='text-gray-400 hover:text-sky-500'>Crescimento</p></Link></li>
          </ul>
        </div>
